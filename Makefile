...
example_schema_files := $(wildcard examples/playbooks/schemas/*)
...
examples/output/%.md: examples/playbooks/%.meta.yml $(example_schema_files) $(package_dir)/templates/playbook.md.j2 $(done_dir)/install_$(pymn).done
	ansible-doc-template-extractor -v --format md --out-dir examples/output $<

examples/output/%.rst: examples/playbooks/%.meta.yml $(example_schema_files) $(package_dir)/templates/playbook.rst.j2 $(done_dir)/install_$(pymn).done
	ansible-doc-template-extractor -v --format rst --out-dir examples/output $<
